...
At some point in time you wonder about having a deadlock and transform your domain model into the jtwfg-model using a graph builder object:
...
as soon as you update both models. Probably you update your domain model and the jtwfg model by using various threads.
