...
If you know an other solution I don't know about, thanks for pointing to it.
...
=== Scenario 2: "Update the jtwfg model" as you update your domain model objects and check for deadlocks on the fly
