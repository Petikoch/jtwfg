...
Since they are both waiting *forever* for each other, they are _deadlocked_.
...
Here, we have a circle consisting of "Task 1", "Task 2" and "Task 3". Since they are all waiting *forever* for each other, they are _deadlocked_.
